...
public class JavaKeyWords {
    ...
    public static void main(String[] args) {
        ...
        // Deklaration udn Zuweisung in einem Schritt
        int zahlB = 11;
        ...
        /*
         * Es lässt sich alles abfragen, was zu wahr oder falsch ausgewertet
         * werden kann: <, >, <=, >=, ==, != oder auch Methoden auf Objekten, zB
         * liste.isEmpty()
         */
        ...
        /*
         * Das funktioniert aber nicht, wenn nicht genug Elemente da sind:
         * folgender Aufruf wirft einen Fehler
         */
